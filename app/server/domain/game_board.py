   ...
   def __init__(self):
      ...
      self.gameBoardPlayersDict = {
         0: {"id": 0, "name": "Miss Scarlet", "isCornerRoom": 0,
             "type": "home space", "adjacentHall": "B",
             "adjacentRoomA": "hall",
             "adjacentRoomB": "lounge", "secretPassage": None,
             "xIndex": 8, "yIndex": 0},
         1: {"id": 1, "name": "Colonel Mustard", "isCornerRoom": 0,
             "type": "home space",
             "adjacentHall": "E", "adjacentRoomA": "lounge",
             "adjacentRoomB": "dining room", "secretPassage": None,
             "xIndex": 12, "yIndex": 4},
         2: {"id": 2, "name": "Mrs. White", "isCornerRoom": 0,
             "type": "home space",
             "adjacentHall": "L", "adjacentRoomA": "ball room",
             "adjacentRoomB": "kitchen", "secretPassage": None,
             "xIndex": 8, "yIndex": 12},
         3: {"id": 3, "name": "Mr. Green", "isCornerRoom": 0,
             "type": "home space",
             "adjacentHall": "K", "adjacentRoomA": "conservatory",
             "adjacentRoomB": "ball room", "secretPassage": None,
             "xIndex": 4, "yIndex": 12},
         4: {"id": 4, "name": "Mrs. Peacock", "isCornerRoom": 0,
             "type": "home space",
             "adjacentHall": "H", "adjacentRoomA": "library",
             "adjacentRoomB": "conservatory", "secretPassage": None,
             "xIndex": 0, "yIndex": 8},
         5: {"id": 5, "name": "Professor Plum", "isCornerRoom": 0,
             "type": "home space",
             "adjacentHall": "C", "adjacentRoomA": "study",
             "adjacentRoomB": "library", "secretPassage": None,
             "xIndex": 0, "yIndex": 4}
      }
